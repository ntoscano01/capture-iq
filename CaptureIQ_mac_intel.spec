...
#
# CaptureIQ — PyInstaller spec for macOS Intel (x86_64)
# Build with:
#   pyinstaller CaptureIQ_mac_intel.spec --noconfirm
#
# Must be run ON an Intel Mac (or Apple Silicon Mac with Rosetta + x86 Python).
